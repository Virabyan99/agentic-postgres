...
Twelve were named in the brief. Seventeen more were found reading the working tree and building it. **D13, D14, D15 and D16 are the ones that break `bin/session-01-check.sh` outright** and should be read first.
