...
| F-011 | Contract tests hard-code the platform domain as the whole surface | **Open** | Untouched in 1.6.1 |
...
| F-022 | The gate cannot pass on this fork | **Open** | It is F-011's consequence |
