...
**Status: Session 30 implemented**, at `template_version` **1.8.0**.
...
sudo bin/materialize-secrets.sh --project project.yaml --requirements secrets.required.yaml --session 30
