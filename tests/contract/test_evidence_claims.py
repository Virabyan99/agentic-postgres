...
CLAIM_INTRODUCED_IN = {
    ...
    "session_lifecycle": 15,
    "agent_credential_lifecycle": 15,
    "password_reset": 15,
    "credential_rotation_surface": 15,
    # Session 16 Run 9: seven claims, all landing with the constant (D690).
    "capability_governance": 16,
    "denial_taxonomy": 16,
    "agent_quota": 16,
    "agent_idempotency": 16,
    "agent_dry_run": 16,
